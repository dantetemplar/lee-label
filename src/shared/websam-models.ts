export type WebsamModelFamily = 'sam2.1' | 'sam1' | 'sam-hq' | 'edgesam' | 'sam3'
...
export const WEBSAM_MODEL_REGISTRY: WebsamModelInfo[] = [
  {
    ...
    decoderSize: 17 * MB,
    totalSize: 44 * MB,
    description: 'Fastest HQ-SAM (TinyViT), good edges for interactive labeling. F32 encoder',
  ...
  },
  {
    ...
    decoderSize: 20 * MB,
    totalSize: 191 * MB,
    description: 'Balanced HQ-SAM, sharper boundaries than Light. F16 encoder',
    encoderKey: 'models/sam-hq-base/v1/encoder.onnx',
  ...
  },
  {
    ...
    decoderSize: 21 * MB,
    totalSize: 610 * MB,
    description: 'Higher-accuracy HQ-SAM, large download. F16 encoder',
    encoderKey: 'models/sam-hq-large/v1/encoder.onnx',
  ...
  },
  {
    ...
    decoderSize: 16 * MB,
    totalSize: 144 * MB,
    description: 'Fastest SAM 2.1. F32 encoder',
  ...
  },
  {
    ...
    decoderSize: 16 * MB,
    totalSize: 82 * MB,
    description: 'Balanced speed and accuracy for SAM 2.1. F16 encoder',
    encoderKey: 'models/sam2.1-small/v1/encoder.onnx',
  ...
  },
  {
    ...
    decoderSize: 16 * MB,
    totalSize: 149 * MB,
    description: 'Higher accuracy SAM 2.1 model. F16 encoder',
    encoderKey: 'models/sam2.1-baseplus/v1/encoder.onnx',
  ...
  },
  {
    ...
    decoderSize: 16 * MB,
    totalSize: 423 * MB,
    description: 'Highest accuracy SAM 2.1, large download. F16 encoder',
    encoderKey: 'models/sam2.1-large/v1/encoder.onnx',
  ...
  },
  {
    ...
    quantization: 'fp16',
    requiresWebGPU: true,
    archiveName: archiveName('sam3-tracker')
  },
  {
    id: 'edgesam',
    name: 'EdgeSAM',
    ...
    decoderSize: 15 * MB,
    totalSize: 36 * MB,
    description: 'Fast CNN SAM (EdgeSAM-3x), runs on WASM. F32 encoder',
...
export const WEBSAM_MODEL_FAMILIES = [
  ...
  { id: 'sam3' as const, label: 'SAM 3', families: ['sam3'] as const },
